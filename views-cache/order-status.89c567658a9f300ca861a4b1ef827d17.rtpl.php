...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="/administrador/orders">Pedidos</a></li>
        <li class="active"><a href="/administrador/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Pedido N°<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
    </ol>
    </section>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <?php } ?>
            <!-- form start -->
            <form role="form" action="/administrador/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status" method="post">
                <div class="box-body">
                ...
                <div class="box-footer">
                    ...
                    <a href="/administrador/orders" class="btn btn-blank"></i> Voltar</a>
                </div>
            </form>
            </div>
            </div>
